...
const toLastNames = people => {
  let NewName = people.map((element) =>
...
const reversedString = (str) => {
  return str.split('').reduce((acc, element) => element + acc, '');
};
